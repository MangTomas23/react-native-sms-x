...
public class SendSMS extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void send(Integer sim, final Integer messageId, String phoneNumber, String message, final Callback cb) {
        ...
        try {
            ...
            TelephonyManager telManager = (TelephonyManager) this.reactContext
                    .getSystemService(Context.TELEPHONY_SERVICE);

            SubscriptionManager manager = (SubscriptionManager) this.reactContext
                    .getSystemService(Context.TELEPHONY_SUBSCRIPTION_SERVICE);
            List<SubscriptionInfo> subscriptionInfos = manager.getActiveSubscriptionInfoList();

            SmsManager sms = SmsManager
                    .getSmsManagerForSubscriptionId(subscriptionInfos.get(sim - 1).getSubscriptionId());
